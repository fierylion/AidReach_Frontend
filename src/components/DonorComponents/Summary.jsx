...
const Summary = ({votes, donations}) => {
  return (
    <section>
      <div className='row'>
        <div className='col-sm-6  '>
          <Slide>
            <SingleSummary name={'Donated'} amount={`${donations} tFill`} />
          </Slide>
        </div>

        <div className='col-sm-6  '>
          <Slide direction='right'>
            <SingleSummary name={'Votes'} amount={votes} />
          </Slide>
        </div>
      </div>
    </section>
   ...
   <>
     <div className='m-5 text-center border h-75 w-75 shadow rounded p-4 d-flex flex-column '>
       ...
       <div className='d-flex mt-3'>
         ...
         <small className='align-self-end  p-1 bg-warning rounded shadow small_text text-primary'>
           3d ago
         </small>
       </div>
     </div>
