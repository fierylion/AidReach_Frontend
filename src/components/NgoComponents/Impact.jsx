        ...
        {inViewport && data && (
          <div className='mx-auto my-4 p-5 border shadow rounded'>
            <div className='m-2 my-3'>
              <h2>Donations</h2>
              <h3>
                <CountUp start={0} end={data.data.donationAmount} duration={2.4} /> tFill
              </h3>
            </div>
            <div className='m-2 my-3'>
              <h2>NGO's</h2>
              <h3>
                <CountUp start={0} end={data.data.noNgos} duration={2.4} /> +
              </h3>
            </div>
            <div className='m-2 my-3'>
              <h2>Proposals</h2>
              <h3>
                <CountUp start={0} end={data.noProposals} duration={2.4} /> +
              </h3>
            </div>
          </div>
        )}
