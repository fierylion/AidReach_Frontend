    ...
    <section className='my-5' id='sect2'>
      <div className='row mx-2'>
        ...
        <div className='col-md-6 p-3'>
          ...
          <p className='text-justify'>
            As a donor, you have the power to vote for the projects you believe
            in. Each Filecoin token you contribute grants you voting power.
          </p>
        </div>
        <div className='col-md-6 p-3'>
          <div className='text-center mb-4'>
          ...
          <p className='text-justify '>
            The blockchain governs the allocation of funds. The project with the
            most votes receives the funds, ensuring complete fairness and
            accountability.
          </p>
        </div>
      </div>
